...
const winProps = {
    ...
    items: [
        ...
        },
        {
            ...
            Fact:
                "Did you know, in the UK we recycle over 80% of our cardboard!",
            Image:
        ...
        },
        {
            ...
            Image:
                "https://www.dropbox.com/s/ufzb1sanh7leklm/fanta_can.png?raw=1",
            Category: "Soft drink",
            type: "recyclable",
            dropped: "recyclingBin",
            correct: true,
...
test("Win case", () => {
    ...
    getAllByTestId("result-text-win");
    getAllByTestId("item-win");
});
...
test("Lose case", () => {
    ...
    getAllByTestId("result-text-lose");
    getAllByTestId("item-lose");
});
